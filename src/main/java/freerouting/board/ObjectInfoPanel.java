...
public interface ObjectInfoPanel
{
     ...
     * Returns false, if that was not possible.
     */
    boolean append(freerouting.geometry.planar.FloatPoint p_point);
     ...
     * Returns false, if that was not possible.
     */
    boolean append(freerouting.geometry.planar.Shape p_shape, java.util.Locale p_locale);
     ...
     */
    boolean append_items( String p_link_name, String p_window_title, java.util.Collection<freerouting.board.Item> p_items);
