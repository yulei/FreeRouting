...
class PopupMenuMain extends PopupMenuDisplay
{
    ...
    PopupMenuMain(BoardFrame p_board_frame)
    {
        ...
        java.util.ResourceBundle resources = 
                java.util.ResourceBundle.getBundle("freerouting.gui.PopupMenuMain", p_board_frame.get_locale());
        ...
        if (board_panel.board_handling.get_routing_board().get_test_level() != freerouting.board.TestLevel.RELEASE_VERSION)
        {
