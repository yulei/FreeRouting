...
public class StitchRouteState extends RouteState
{
    ...
    public void draw(java.awt.Graphics p_graphics)
    {
        ...
        freerouting.rules.NetClass default_net_class = hdlg.get_routing_board().rules.get_default_net_class();
        int cl_class = default_net_class.default_item_clearance_classes.get(freerouting.rules.DefaultItemClearanceClasses.ItemClass.TRACE);
